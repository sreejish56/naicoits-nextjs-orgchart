...
## Install
```
npm install @naicoits/nextjs-orgchart
```

<h2>How to Use </h2>
In your \_app.js :
import "@naicoits/nextjs-orgchart/dist/ChartContainer.css";
import "@naicoits/nextjs-orgchart/dist/ChartNode.css";

After that u can import the chart in your component file :
import OrganizationChart from "@naicoits/nextjs-orgchart"
